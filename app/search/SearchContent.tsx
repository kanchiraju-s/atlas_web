    ...
    <div>
      <div style={{ position: 'relative', marginBottom: 40 }}>
        ...
        <input
          ...
          style={{ width: '100%', padding: '14px 16px 14px 44px', fontSize: 15, background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, color: 'var(--text-primary)', outline: 'none', transition: 'border-color 150ms' }}
          ...
          {!hasResults && (
            <div style={{ paddingTop: 8 }}>
              <p style={{ fontSize: 14, color: 'var(--text-muted)', marginBottom: 24 }}>
                Nothing found for &ldquo;{dq}&rdquo;.
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                >
                  <div>
                    <p style={{ fontWeight: 500, marginBottom: 2 }}>Create &ldquo;{dq}&rdquo;</p>
